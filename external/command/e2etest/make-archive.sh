...
LDFLAGS="-X github.com/opentofu/opentofu/external/command/e2etest.tofuBin=./tofu$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/opentofu/opentofu/external/command/e2etest
