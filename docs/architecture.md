...
[the `command` package](https://pkg.go.dev/github.com/opentofu/opentofu/external/command).
...
[`backend.Operation`](https://pkg.go.dev/github.com/opentofu/opentofu/external/backend#Operation)
...
[`backend.Backend`](https://pkg.go.dev/github.com/opentofu/opentofu/external/backend#Backend), using a
mapping table in
[the `backend/init` package](https://pkg.go.dev/github.com/opentofu/opentofu/external/backend/init).

Backends that are able to execute operations additionally implement
[`backend.Enhanced`](https://pkg.go.dev/github.com/opentofu/opentofu/external/backend#Enhanced);
...
[`local.Local`](https://pkg.go.dev/github.com/opentofu/opentofu/external/backend/local#Local),
...
(either
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/opentofu/opentofu/external/states/statemgr#Filesystem) if the
...
[`tofu.Context`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#Context),
...
[`Plan`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#Context.Plan)
or
[`Apply`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#Context.Apply), which in turn constructs a graph using a _graph builder_,
described in a later section.

## Configuration Loader

The top-level configuration structure is represented by model types in
[package `configs`](https://pkg.go.dev/github.com/opentofu/opentofu/external/configs).
A whole configuration (the root module plus all of its descendent modules)
is represented by
[`configs.Config`](https://pkg.go.dev/github.com/opentofu/opentofu/external/configs#Config).
...
[`configload`](https://pkg.go.dev/github.com/opentofu/opentofu/external/configs/configload]),
via
[`configload.Loader`](https://pkg.go.dev/github.com/opentofu/opentofu/external/configs/configload#Loader).
...
[the `statemgr` package](https://pkg.go.dev/github.com/opentofu/opentofu/external/states/statemgr),
with most practical managers implementing the full set of operations
described by
[`statemgr.Full`](https://pkg.go.dev/github.com/opentofu/opentofu/external/states/statemgr#Full)
...
The implementation
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/opentofu/opentofu/external/states/statemgr#Filesystem) is used
...
[`states.State`](https://pkg.go.dev/github.com/opentofu/opentofu/external/states#State)
...
[`GraphNodeConfigResource`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#GraphNodeConfigResource)
...
[`tofu.GraphTransformer`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#GraphTransformer).
...
* [`ConfigTransformer`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#ConfigTransformer),
  which creates a graph vertex for each `resource` block in the configuration.

* [`StateTransformer`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#StateTransformer),
  which creates a graph vertex for each resource instance currently tracked
  in the state.

* [`ReferenceTransformer`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#ReferenceTransformer),
...
* [`ProviderTransformer`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#ProviderTransformer),
...
[`tofu.Graph`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#Graph), which
...
[the low-level `dag` package](https://pkg.go.dev/github.com/opentofu/opentofu/external/dag#AcyclicGraph.Walk)
(where "DAG" is short for [_Directed Acyclic Graph_](https://en.wikipedia.org/wiki/Directed_acyclic_graph)), in
[`AcyclicGraph.Walk`](https://pkg.go.dev/github.com/opentofu/opentofu/external/dag#AcyclicGraph.Walk).
However, the "interesting" OpenTofu walk functionality is implemented in
[`tofu.ContextGraphWalker`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#ContextGraphWalker),
...
* `EnterPath` is called once for each module in the configuration, taking a
  ...
  [`tofu.EvalContext`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#EvalContext)
...
[`states.SyncState`](https://pkg.go.dev/github.com/opentofu/opentofu/external/states#SyncState)
...
[`tofu.Execute`](https://pkg.go.dev/github.com/opentofu/opentofu/external/erraform#Execute).
...
[`tofu.BuiltinEvalContext`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#BuiltinEvalContext).
...
[`tofu.GraphNodeExecutable`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#GraphNodeExecutable),
...
* [NodePlannableResource.Execute](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#NodePlannableResourceInstance.Execute), which handles the `plan` operation.

* [`NodeApplyableResourceInstance.Execute`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#NodeApplyableResourceInstance.Execute), which handles the main `apply` operation.

* [`NodeDestroyResourceInstance.Execute`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#EvalWriteState), which handles the main `destroy` operation.
...
1. Analyze the configuration expressions to see which other objects they refer
  ...
  [`lang.References`](https://pkg.go.dev/github.com/opentofu/opentofu/external/lang#References),
  or more often one of the helper wrappers around it:
  [`lang.ReferencesInBlock`](https://pkg.go.dev/github.com/opentofu/opentofu/external/lang#ReferencesInBlock)
  or
  [`lang.ReferencesInExpr`](https://pkg.go.dev/github.com/opentofu/opentofu/external/lang#ReferencesInExpr)
...
of the methods on [`lang.Scope`](https://pkg.go.dev/github.com/opentofu/opentofu/external/lang#Scope);
most commonly,
[`lang.EvalBlock`](https://pkg.go.dev/github.com/opentofu/opentofu/external/lang#Scope.EvalBlock)
or
[`lang.EvalExpr`](https://pkg.go.dev/github.com/opentofu/opentofu/external/lang#Scope.EvalExpr).
...
[`tofu.GraphNodeDynamicExpandable`](https://pkg.go.dev/github.com/opentofu/opentofu/external/tofu#GraphNodeDynamicExpandable).
